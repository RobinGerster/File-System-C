...
typedef struct a1fs_superblock {
    ...
    a1fs_blk_t block_bitmap; /* A pointer to the beginning of the block bitmap */
    a1fs_blk_t inode_bitmap; /* A pointer to the beginning of the inode bitmap */
    a1fs_blk_t inode_table; /* Pointer to beginning of inode table*/
    a1fs_blk_t extent_table; /* Pointer to beginning of the extent tables*/
    a1fs_blk_t data_blocks; /* Pointer to the first of the free data blocks */
...
typedef struct a1fs_inode {
    ...
    a1fs_blk_t extent_table; /* Pointer to the extent table for this inode*/
    char padding[24]; /* Required padding */
...
typedef struct a1fs_extent_table {
    a1fs_extent  i_extents[512]; /* The extents of this table (every inode has one a1fs_extent_table) */
} a1fs_extent_table;
